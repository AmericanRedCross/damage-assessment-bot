...
// describe("api/v1/myanmar/disasterAssessment/import function", () => {
...
//         let mockDisasterAssessmentService = genericMock<MyanmarDisasterAssessmentService>();
//         let importService = new MyanmarDisasterAssessmentImportService(mockDisasterAssessmentService);
